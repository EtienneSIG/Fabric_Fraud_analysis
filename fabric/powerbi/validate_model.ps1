...
try {
  $r = Invoke-RestMethod -Uri "https://api.powerbi.com/v1.0/myorg/groups/$Workspace/datasets/$ModelId/executeQueries" -Headers $h -Method Post -Body $body
...
try {
  $r2 = Invoke-RestMethod -Uri "https://api.powerbi.com/v1.0/myorg/groups/$Workspace/datasets/$ModelId/executeQueries" -Headers $h -Method Post -Body $body2
  "--- Top Sankey flows ---"
